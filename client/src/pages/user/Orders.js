            ...
            <center>
                <div className='flex flex-row pt-24 md:pt-36 lg:pt-24 w-11/12 lg:w-5/6'>
                    ...
                    <div className='basis-full lg:basis-10/12 xl:basis-4/5'>
                        <h1 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-2'><span className='border-2 rounded-2xl px-4 py-2 bg-blue-500 text-white'>Your Orders</span></h1>
