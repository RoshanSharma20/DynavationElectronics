            ...
            <center>
                <div className='flex flex-row pt-24 md:pt-36 lg:pt-24 w-11/12 lg:w-5/6'>
                    ...
                    <div className='basis-full lg:basis-10/12 xl:basis-4/5'>
                        <h1 className='text-xl md:text-2xl lg:text-3xl xl:text-4xl my-10'><span className='border-4 border-gray-500 font-serif font-bold rounded-xl px-6 py-3 bg-white text-black'>All Orders</span></h1>
