        ...
        <Layout title={"Dynavation Electronics - Home Page"}>
            ...
            <center>
                ...
                <div className='w-full xl:w-11/12 mt-8'>
                    <h1 className='text-xl md:text-2xl lg:text-3xl xl:text-4xl my-10'><span className='border-4 border-gray-500 font-serif font-bold rounded-xl px-6 py-3 bg-white text-black'>Shop by Category</span></h1>
                ...
                <div className='w-11/12 xl:w-5/6 pt-8'>
                    <h1 className='text-xl md:text-2xl lg:text-3xl xl:text-4xl my-10'><span className='border-4 border-gray-500 font-serif font-bold rounded-xl px-6 py-3 bg-white text-black'>Featured Products</span></h1>
                    <div>
