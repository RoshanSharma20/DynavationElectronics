        ...
        <Layout title={"Dynavation Electronics - Home Page"}>
            <center>
                ...
                <div className='w-full xl:w-11/12 pt-8'>
                    <h1 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl bg-gradient-to-b from-slate-100 via-sky-400 to-blue-800 bg-clip-text text-transparent py-1'>Shop by Category</h1>
                ...
                <div className='w-11/12 xl:w-5/6 pt-8'>
                    <h1 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-8 bg-gradient-to-b from-slate-100 via-sky-400 to-blue-800 bg-clip-text text-transparent'>Featured Products</h1>
                    <div>
                ...
                <div className='w-11/12 xl:w-5/6 pt-8'>
                    <h1 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-8 bg-gradient-to-b from-slate-100 via-sky-400 to-blue-800 bg-clip-text text-transparent'>Our Esteemed Partners</h1>
                ...
                <div className='w-10/12 xl:w-5/6 pt-8'>
                    <h1 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-8 bg-gradient-to-b from-slate-100 via-sky-400 to-blue-800 bg-clip-text text-transparent'>Why Choose Us</h1>
