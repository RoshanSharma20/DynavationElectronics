                    ...
                    <Navbar.Collapse>
                        ...
                        <div className='pt-3'>
                            <Badge count={cart?.length} showZero size="small" offset={[7, 4]}>
                                ...
                                <Link to="/cart" className='text-md xl:text-lg pt-4  2xl:px-2 md:hidden font-medium hover:text-blue-700 hover:underline underline-offset-3 transition ease-in-out delay-200 hover:-translate-y-1 duration-150 hover:scale-110'>
                                    Cart
                                </Link>
                            </Badge>
                        </div>
